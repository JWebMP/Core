 ...
 * @version 1.0
 */
public class BlankComponentFeature extends Feature<BlankComponentOptions, BlankComponentFeature> implements BlankComponentFeatures, GlobalFeatures
{
     ...
     * @param forComponent
     */
    public BlankComponentFeature(Component forComponent)
    {
        super("Blank");
