 ...
 * @since 20 Apr 2016
 */
public enum BSButtonToolbarReferencePool implements ReferencePool
{

    ;
    private BSButtonToolbarReferencePool()
    {
    }
    ...
    private BSButtonToolbarReferencePool(JavascriptReference javaScriptReference, CSSReference cssReference)
    {
