 ...
 * @since 20 Apr 2016
 */
public enum BSBreadcrumbsReferencePool implements ReferencePool
{

    ;
    private BSBreadcrumbsReferencePool()
    {
    }
    ...
    private BSBreadcrumbsReferencePool(JavascriptReference javaScriptReference, CSSReference cssReference)
    {
