 ...
 * @since 20 Apr 2016
 */
public enum BSCardReferencePool implements ReferencePool
{

    ;
    private BSCardReferencePool()
    {
    }
    ...
    private BSCardReferencePool(JavascriptReference javaScriptReference, CSSReference cssReference)
    {
