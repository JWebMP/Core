...
public class SB2Theme extends Theme
{
    ...
    public SB2Theme()
    {
        ...
        getCssReferences().add(BootstrapReferencePool.BootstrapSBAdmin2Reference.getCssReference());
        getCssReferences().add(BootstrapReferencePool.BootstrapSocialThemeReference.getCssReference());
    }
