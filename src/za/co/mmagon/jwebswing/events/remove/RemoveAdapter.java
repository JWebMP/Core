		...
		implements GlobalEvents
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute(AngularAttributes.ngRemove, STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	...
	public boolean equals(Object o)
	{
		...
		RemoveAdapter that = (RemoveAdapter) o;
