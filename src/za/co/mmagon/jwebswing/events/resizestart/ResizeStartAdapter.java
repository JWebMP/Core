 ...
 * @author Marc Magon
 */
public abstract class ResizeStartAdapter extends Event
		implements GlobalEvents
{
	 ...
	 */
	private static final java.util.logging.Logger LOG = LogFactory.getInstance().getLogger("ResizeStartEvent");
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute(AngularAttributes.ngResizeStart, STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
