 ...
 * @author Marc Magon
 */
public abstract class SelectAdapter extends Event
        implements GlobalEvents, JQUIAutoCompleteEvents, JQUIMenuEvents, JQUISelectMenuEvents
{

    /**
     * Logger for the Component
     */
    private static final java.util.logging.Logger LOG = LogFactory.getInstance().getLogger("SelectEvent");
    ...
    public SelectDirective getDirective()
    {
        if (directive == null)
        {
            directive = new SelectDirective(getComponent().getPage().getAngular());
        }
        return directive;
    }
