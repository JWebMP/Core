 ...
 * @since 25 Jun 2016
 */
public class SelectingDirective extends AngularDirectiveBase
{
    ...
    {
        return FileTemplates.getFileTemplate(SelectingDirective.class, "Selecting").toString();
    }
