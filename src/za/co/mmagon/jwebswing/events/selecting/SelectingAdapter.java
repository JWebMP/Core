		...
		implements GlobalEvents
{
	 ...
	 */
	private static final java.util.logging.Logger LOG = LogFactory.getInstance().getLogger("SelectingEvent");
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute(AngularAttributes.ngSelecting, STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof SelectingAdapter))
		{
			return false;
		}
		if (!super.equals(o))
		...
		SelectingAdapter that = (SelectingAdapter) o;
