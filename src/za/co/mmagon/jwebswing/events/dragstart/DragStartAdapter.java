		...
		implements GlobalEvents
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute(AngularAttributes.ngDragStart, STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof DragStartAdapter))
		{
			return false;
		}
		if (!super.equals(o))
		...
		DragStartAdapter that = (DragStartAdapter) o;
