 ...
 * @author Marc Magon
 */
@ComponentInformation(name = "Blur Event", description = "Server Side Event for Blur Event.",
		...
		implements GlobalEvents
{
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute(AngularAttributes.ngBlur, STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
