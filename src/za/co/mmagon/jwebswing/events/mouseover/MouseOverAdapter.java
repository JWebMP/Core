 ...
 * @author Marc Magon
 */
public abstract class MouseOverAdapter extends Event
		implements GlobalEvents
{
	 ...
	 */
	private static final java.util.logging.Logger LOG = LogFactory.getInstance().getLogger("MouseOverEvent");
	...
	public void preConfigure()
	{
		if (!isConfigured())
		{
			...
			getComponent().addAttribute(AngularAttributes.ngMouseover, STRING_ANGULAR_EVENT_START + renderVariables() + STRING_CLOSING_BRACKET_SEMICOLON);
		}
		super.preConfigure();
	}
