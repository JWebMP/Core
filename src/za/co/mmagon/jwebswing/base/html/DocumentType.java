 ...
 *
 */
public class DocumentType extends ComponentHTMLBase<GlobalFeatures, GlobalEvents, ComponentHTMLBase> implements NoNewLineForRawText
{
     ...
     *
     * @param clientHtmlVersion The browser HTML version to render for, usually
     *                          the clients. This gets set by the JWebSwing
     *                          Servlet.
     */
