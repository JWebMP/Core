 ...
 * this element and buttons created with the &gt;input&lt; element. &gt;p&lt;
 * <p>
 * Tip: Always specify the type attribute for a &gt;button&lt; element.<p>
 * Different browsers use different default types for
 * the &gt;button&lt; element. Browser Support
 * <p>
 ...
 * browsers may submit different values.
 * <p>
 * Use &gt;input&lt; to create buttons in an HTML form.<p>
 * Differences Between HTML 4.01 and HTML5 &gt;p&lt; HTML5 has the following new
 * attributes: autofocus, form,
