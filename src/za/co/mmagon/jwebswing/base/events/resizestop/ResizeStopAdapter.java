package za.co.mmagon.jwebswing.base.events.resizestop;
        ...
        implements GlobalEvents
{
     ...
     */
    private static final org.apache.log4j.Logger LOG = LoggerFactory.getInstance().makeNewLoggerInstance("ResizeStopEvent");
    ...
    public ResizeStopDirective getDirective()
    {
        if (directive == null)
        {
            directive = new ResizeStopDirective(getComponent().getPage().getAngular());
        }
        return directive;
    }
