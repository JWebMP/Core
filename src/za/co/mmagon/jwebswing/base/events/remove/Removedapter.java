package za.co.mmagon.jwebswing.base.events.remove;
 ...
 * @author Marc Magon
 */
public abstract class Removedapter extends Event 
        implements GlobalEvents
{
     ...
     */
    private static final org.apache.log4j.Logger LOG = LoggerFactory.getInstance().makeNewLoggerInstance("RemoveEvent");
     ...
     */
    public Removedapter(Component component)
    {
    ...
    public RemoveDirective getDirective()
    {
        if (directive == null)
        {
            directive = new RemoveDirective(getComponent().getPage().getAngular());
        }
        return directive;
    }
