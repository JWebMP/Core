package za.co.mmagon.jwebswing.base.events.drop;
        ...
        implements GlobalEvents
{
     ...
     */
    private static final org.apache.log4j.Logger LOG = LoggerFactory.getInstance().makeNewLoggerInstance("DropEvent");
    ...
    public DropDirective getDirective()
    {
        if (directive == null)
        {
            directive = new DropDirective(getComponent().getPage().getAngular());
        }
        return directive;
    }
