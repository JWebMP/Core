package za.co.mmagon.jwebswing.base.events.drag;
        ...
        implements GlobalEvents
{
     ...
     */
    private static final org.apache.log4j.Logger LOG = LoggerFactory.getInstance().makeNewLoggerInstance("DragEvent");
    ...
    public DragDirective getDirective()
    {
        if (directive == null)
        {
            directive = new DragDirective(getComponent().getPage().getAngular());
        }
        return directive;
    }
