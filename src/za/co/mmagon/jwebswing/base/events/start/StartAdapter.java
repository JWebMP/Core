package za.co.mmagon.jwebswing.base.events.start;
        ...
        implements GlobalEvents
{
     ...
     */
    private static final org.apache.log4j.Logger LOG = LoggerFactory.getInstance().makeNewLoggerInstance("StartEvent");
    ...
    public void preConfigure()
    {
        if (!isConfigured())
        {
            ...
            component.addAttribute(AngularAttributes.ngStart, "perform($event," + renderVariables() + ");");
        }
        super.preConfigure();
    }
    ...
    public StartDirective getDirective()
    {
        if (directive == null)
        {
            directive = new StartDirective(getComponent().getPage().getAngular());
        }
        return directive;
    }
