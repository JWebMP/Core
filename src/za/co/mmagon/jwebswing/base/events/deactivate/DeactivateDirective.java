 ...
 */
package za.co.mmagon.jwebswing.base.events.deactivate;
 ...
 * @since 25 Jun 2016
 */
public class DeactivateDirective extends AngularDirectiveBase
{
    ...
    {
        return getAngular().getFileTemplate(DeactivateDirective.class, "Deactivate").toString();
    }
