 ...
 * @since 25 Jun 2016
 */
public class JWAngularConfiguration extends AngularControllerBase
{
	...
	public String renderFunction()
	{
		...
		Set<Class<? extends AngularConfigurationScopeStatement>> controllers = GuiceContext.reflect().getSubTypesOf(AngularConfigurationScopeStatement.class);
		controllers.forEach(a ->
		                    {
			                    AngularConfigurationScopeStatement statement = GuiceContext.inject().getInstance(a);
