...
import za.co.mmagon.jwebswing.base.events.activate.Activatedapter;
import za.co.mmagon.jwebswing.base.events.beforeactivate.BeforeActivateAdapter;
import za.co.mmagon.jwebswing.base.events.beforeclose.BeforeCloseAdapter;
import za.co.mmagon.jwebswing.base.events.beforeload.BeforeLoadAdapter;
import za.co.mmagon.jwebswing.base.events.beforestop.BeforeStopAdapter;
import za.co.mmagon.jwebswing.base.events.blur.BlurAdapter;
import za.co.mmagon.jwebswing.base.events.buttonclick.ButtonClickAdapter;
import za.co.mmagon.jwebswing.base.events.cancel.CancelAdapter;
import za.co.mmagon.jwebswing.base.events.checked.CheckedAdapter;
import za.co.mmagon.jwebswing.base.events.click.ClickAdapter;
import za.co.mmagon.jwebswing.base.events.close.CloseAdapter;
import za.co.mmagon.jwebswing.base.events.complete.CompleteAdapter;
import za.co.mmagon.jwebswing.base.events.create.CreateAdapter;
import za.co.mmagon.jwebswing.base.events.deactivate.DeactivateAdapter;
import za.co.mmagon.jwebswing.base.events.dragstart.DragStartAdapter;
import za.co.mmagon.jwebswing.base.events.dragstop.DragStopAdapter;
import za.co.mmagon.jwebswing.base.events.drop.DropAdapter;
import za.co.mmagon.jwebswing.base.events.load.LoadAdapter;
import za.co.mmagon.jwebswing.base.events.mousedown.MouseDownAdapter;
import za.co.mmagon.jwebswing.base.events.mouseenter.MouseEnterAdapter;
import za.co.mmagon.jwebswing.base.events.mousemove.MouseMoveAdapter;
import za.co.mmagon.jwebswing.base.events.mouseout.MouseOutAdapter;
import za.co.mmagon.jwebswing.base.events.mouseover.MouseOverAdapter;
import za.co.mmagon.jwebswing.base.events.open.OpenAdapter;
import za.co.mmagon.jwebswing.base.events.receive.ReceiveAdapter;
import za.co.mmagon.jwebswing.base.events.remove.Removedapter;
import za.co.mmagon.jwebswing.base.events.resize.ResizeAdapter;
...
import za.co.mmagon.jwebswing.base.events.slide.SlideAdapter;
import za.co.mmagon.jwebswing.base.events.sort.SortAdapter;
import za.co.mmagon.jwebswing.base.events.spin.SpinAdapter;
import za.co.mmagon.jwebswing.base.events.start.StartAdapter;
import za.co.mmagon.jwebswing.base.events.stop.StopAdapter;
import za.co.mmagon.jwebswing.base.events.unselected.UnSelectedEvent;
import za.co.mmagon.jwebswing.base.events.update.UpdateEvent;
...
public enum EventTypes implements Comparable<EventTypes>
{
    ...
    /**
     * Registers when a drag starts
     * Triggered when the user starts dragging the dialog.
     */
    dragStart(DragStartAdapter.class, null),
    /**
     * Registers when a drag stops
     ...
     * If the accordion is collapsing, ui.newHeader and ui.newPanel will be empty jQuery objects.
     * <p>
     * Triggered immediately before a tab is activated. Can be canceled to prevent the tab from activating.
     * If the tabs are currently collapsed, ui.oldTab and ui.oldPanel will be empty jQuery objects. If the tabs are collapsing,
     * ui.newTab and ui.newPanel will be empty jQuery objects.
     */
    ...
    unselected(UnSelectedEvent.class, null),
    ...
    remove(Removedapter.class, null),
     ...
     * <p>
     * Note: Although ui.ajaxSettings is provided and can be modified, some of these properties have already been processed by jQuery.
     * For example, prefilters have been applied, data has been processed, and type has been determined.
     * The beforeLoad event occurs at the same time,
     * and therefore has the same restrictions, as the beforeSend callback from jQuery.ajax().
     * <p>
     */
