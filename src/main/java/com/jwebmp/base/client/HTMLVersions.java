...
public enum HTMLVersions
{
	...
	All("<!DOCTYPE html>"),
	/**
	 * This DTD is equal to XHTML 1.0 Strict, but allows you to add modules (for example to provide ruby support for East-Asian languages). This one first so it never gets
	 * considered
	 */
	...
	/**
	 * This DTD contains all HTML elements and attributes, INCLUDING presentational and deprecated elements (like font). Framesets are not allowed. The markup must also be written
	 * as well-formed XML.
	 */
