...
import com.jwebmp.base.html.interfaces.children.TableHeaderGroupChildren;
 ...
 * .<p>
 * <p>
 * Browsers can use these elements to enable scrolling of the table body independently of the header and footer. Also, when printing a large table that spans multiple pages, these
 * elements can
 * enable<p>
 * the table header and footer to be printed at the top and bottom of each page.<p>
 * <p>
 * The thead tag must be used in the following context: As a child of a table element, after any caption, and colgroup elements, and before any tbody, tfoot, and tr elements. Tips
 * and<p>
 * Notes<p>
 * <p>
 * Note: The thead element must have one or more tr tags inside.<p>
 * <p>
 * Tip: The thead, tbody, and tfoot elements will not affect the layout of the table by default. However, you can use CSS to style these elements. Differences Between HTML 4.01 and
 * HTML5<p>
 * <p>
