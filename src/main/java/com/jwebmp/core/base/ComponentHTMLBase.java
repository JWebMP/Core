        ...
        IComponentHTMLBase<J>
{
    ...
    public StringBuilder setHtml(StringBuilder html)
    {
        this.html = html;
        return html;
    }
    ...
    *//**
 * Clears the internal html cache for this component for a new render
 *//*
    @Override
    ...
    protected StringBuilder renderHTML(int tabCount)
    {
        ...
        if (true) ;//html == null)
        {
            ...
            if (isInlineClosingTag())
            {
                ...
                return /*html = */new StringBuilder(tempStringBuilder);
            }
