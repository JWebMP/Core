        ...
        implements IComponentFeatureBase<F, J>, Comparator<J>, Comparable<J>
{
     ...
     *
     * @param name The name of this component/feature
     */
     ...
     *
     * @param componentType The given component type of this component
     */
     ...
     *
     * @param feature Any given feature
     * @return This class
     ...
     *
     * @param variable Adds a variable for this feature to assign
    ...
    public void checkAssignedFunctions()
    {
        if (!isRenderAfterLoad())
        {
            ...
            {
                getFeatures().forEach(t -> t.asFeatureBase()
                                            .checkAssignedFunctions());
            }
            if (!isInitialized())
            {
     ...
     * Sets if this feature must be rendered in an $(document).ready statement
     *
     * @param renderAfterLoad if this feature has called assignTo...
     ...
     * Method compare ...
     *
     * @param o1 of type ComponentFeatureBase
     * @param o2 of type ComponentFeatureBase
     * @return int
     */
    @Override
     ...
     * Returns if the JavaScript for this component is rendered elsewhere
     *
     * @param javascriptRenderedElsewhere if it must render manually somewhere else
     * @return this class
     */
    @NotNull
    @SuppressWarnings({"unused",
