 ...
 */
@Log
public abstract class ReceiveAdapter<J extends ReceiveAdapter<J>>
		...
		implements GlobalEvents<J>
{
	 ...
	 */
	public ReceiveAdapter(com.jwebmp.core.base.interfaces.IComponentHierarchyBase<?,?> component)
	{
