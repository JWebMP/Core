...
public class PaddingImpl
		extends CSSImplementationAdapter<Padding, PaddingImpl>
		implements CSSImplementationClass<Padding, PaddingImpl>
{
	...
	{
		String out = "";
		out += paddingTop + StaticStrings.STRING_SPACE;
		out += paddingTop$ + StaticStrings.STRING_SPACE;
		out += paddingRight + StaticStrings.STRING_SPACE;
		out += paddingRight$ + StaticStrings.STRING_SPACE;
		out += paddingBottom + StaticStrings.STRING_SPACE;
		out += paddingBottom$ + StaticStrings.STRING_SPACE;
		out += paddingLeft + StaticStrings.STRING_SPACE;
		out += paddingLeft$ + StaticStrings.STRING_SPACE;
