 ...
 */
package com.jwebmp.htmlbuilder.css.outline;
...
public class OutlineCSSImpl
		extends CSSImplementationAdapter<OutlineCSS, OutlineCSSImpl>
		implements CSSImplementationClass<OutlineCSS, OutlineCSSImpl>
{
	...
	@CSSDetail(cssName = "outline-style",
			cssVersion = CSSVersions.CSS21)
	private BorderStyles outlineStyle;
	@CSSDetail(cssName = "outline-width",
			cssVersion = CSSVersions.CSS21)
	private MeasurementCSSImpl outlineWidth;
	@CSSDetail(cssName = "outline-offset",
			cssVersion = CSSVersions.CSS21)
