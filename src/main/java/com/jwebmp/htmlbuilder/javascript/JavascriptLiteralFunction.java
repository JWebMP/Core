 ...
 */
package com.jwebmp.htmlbuilder.javascript;
 ...
 * @since 30 Dec 2015
 */
public abstract class JavascriptLiteralFunction<J extends JavascriptLiteralFunction<J>>
		extends JavascriptFunction<J>
{
	...
	public String renderFunction()
	{
		...
		literalFunctionStartingString = new StringBuilder("function (" + functionArugments.toString()
		                                                                                  .replace("[", "")
		                                                                                  .replace("]", "") + ") {");
