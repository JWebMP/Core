 ...
 */
package com.jwebmp.htmlbuilder.css.lists;
...
import com.jwebmp.htmlbuilder.css.image.ImageCSSImpl;
 ...
 * <p>
 * Set different list item markers for ordered lists Set different list item markers for unordered lists Set an image as the list item marker Add background colors to lists and
 * list items
 *
 * @author GedMarc
 * @since 18 Jan 2016
 */
public class ListCSSImpl
		extends CSSImplementationAdapter<ListCSS, ListCSSImpl>
		implements CSSImplementationClass<ListCSS, ListCSSImpl>
{
	...
	@CSSDetail(cssName = "list-style-position",
			cssVersion = CSSVersions.CSS21)
	private ListStylePosition listStylePosition;
	@CSSDetail(cssName = "list-style-type",
			cssVersion = CSSVersions.CSS21)
	 ...
	 */
	public void setListStylePosition(com.jwebmp.htmlbuilder.css.lists.ListStylePosition listStylePosition)
	{
	 ...
	 * @param listStyleType
	 */
	public void setListStyleType(com.jwebmp.htmlbuilder.css.lists.ListStyleType listStyleType)
	{
