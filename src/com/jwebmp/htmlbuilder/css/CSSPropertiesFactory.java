...
import com.jwebmp.htmlbuilder.css.composer.CSSLine;
		...
		implements Serializable
{
	...
	private void processBlock(CSSBlock newCSSBlock, StringBuilder key, Object value)
	{
		         ...
		         .isArray())
		{
			...
			{
				valueString = new StringBuilder(valueString.substring(0, valueString.lastIndexOf(STRING_COMMNA))
				                                           .trim());
			}
	...
	private Object processFieldEntry(Object newInstance, Object fieldObject, Field f) throws IllegalAccessException, ClassNotFoundException
	{
		...
		else if (fieldObject instanceof String || fieldObject instanceof Long || fieldObject instanceof Double || fieldObject instanceof Boolean || fieldObject instanceof BigDecimal || fieldObject instanceof ColourCSSImpl)
		{
