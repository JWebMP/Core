...
import com.jwebmp.htmlbuilder.css.enumarations.Repeats;
import com.jwebmp.htmlbuilder.css.image.ImageCSSImpl;
import com.jwebmp.htmlbuilder.css.interfaces.CSSShortHand;
		...
		implements CSSShortHand, CSSImplementationClass<Background, BackgroundImpl>
{
	...
	{
		String output = backgroundColor + STRING_SPACE + backgroundColor$ + STRING_SPACE + backgroundImage + STRING_SPACE + backgroundPosition + STRING_SPACE + Arrays.toString(
				backgroundSize) + STRING_SPACE + backgroundRepeat + STRING_SPACE + backgroundOrigin + STRING_SPACE + backgroundClip + STRING_SPACE + backgroundAttachment;
