		...
		extends BaseTestClass
{
	...
	public void test()
	{
		...
		Assertions.assertEquals(
				"<div id=\"test\" ng-before-activate=\"jwCntrl.perform($event,['jwCntrl.jw.localstorage'],'test','com.jwebmp.core.events.beforeactivate" +
				"" +
				".BeforeActivateAdapterTest$1');\"></div>",
				test.toString(0));
	}
