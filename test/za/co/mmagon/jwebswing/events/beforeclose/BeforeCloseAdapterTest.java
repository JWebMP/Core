...
class BeforeCloseAdapterTest extends BaseTestClass
{
	@Test
	void test()
	{
		...
		Assertions.assertEquals("<div id=\"test\" ng-before-close=\"jwCntrl.perform($event,[],'za_co_mmagon_jwebswing_events_beforeclose_BeforeCloseAdapterTest$1','za.co.mmagon.jwebswing.events.beforeclose.BeforeCloseAdapterTest$1');\"></div>", test.toString(0));
	}
