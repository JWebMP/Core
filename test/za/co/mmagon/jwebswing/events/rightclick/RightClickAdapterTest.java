...
class RightClickAdapterTest extends BaseTestClass
{
	@Test
	void test()
	{
		...
		Assertions.assertEquals("<div id=\"test\" ng-right-click=\"jwCntrl.perform($event,[],'za_co_mmagon_jwebswing_events_rightclick_RightClickAdapterTest$1','za.co.mmagon.jwebswing.events.rightclick.RightClickAdapterTest$1');\"></div>", test.toString(0));
	}
