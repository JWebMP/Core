...
public class SelectingAdapterTest extends BaseTestClass
{
	...
	public void test()
	{
		...
		Assertions.assertEquals("<div id=\"test\" ng-selecting=\"jwCntrl.perform($event,[],'test','za.co.mmagon.jwebswing.events.selecting.SelectingAdapterTest$1');\"></div>", test.toString(0));
	}
