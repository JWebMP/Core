...
public class BeforeActivateAdapterTest extends BaseTestClass
{
	...
	public void test()
	{
		...
		Assertions.assertEquals("<div id=\"test\" ng-before-activate=\"jwCntrl.perform($event,[],'test','za.co.mmagon.jwebswing.events.beforeactivate.BeforeActivateAdapterTest$1');\"></div>", test.toString(0));
	}
