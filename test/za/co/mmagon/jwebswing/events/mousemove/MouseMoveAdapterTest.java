...
public class MouseMoveAdapterTest extends BaseTestClass
{
	...
	public void test()
	{
		...
		Assertions.assertEquals("<div id=\"test\" ng-mousemove=\"jwCntrl.perform($event,[],'test','za.co.mmagon.jwebswing.events.mousemove.MouseMoveAdapterTest$1');\"></div>", test.toString(0));
	}
