...
public class ResizeStopAdapterTest extends BaseTestClass
{
	...
	public void test()
	{
		...
		Assertions.assertEquals("<div id=\"test\" ng-resize-stop=\"jwCntrl.perform($event,[],'test','za.co.mmagon.jwebswing.events.resizestop.ResizeStopAdapterTest$1');\"></div>", test.toString(0));
	}
